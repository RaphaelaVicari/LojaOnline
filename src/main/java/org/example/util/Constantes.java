...
public class Constantes {
    ...
    public static void aberturaDaLoja() {
        ...
        System.out.println("   .d8888b.  888    888  .d88888b.   .d8888b.   .d88888b.    ");
        System.out.println("  d88P  Y88b 888    888 d88P   Y88b d88P  Y88b d88P   Y88b   ");
        System.out.println("  888    888 888    888 888     888 888    888 888     888   ");
        System.out.println("  888        8888888888 888     888 888        888     888   ");
        System.out.println("  888        888    888 888     888 888        888     888   ");
        System.out.println("  888    888 888    888 888     888 888    888 888     888   ");
        System.out.println("  Y88b  d88P 888    888 Y88b. .d88P Y88b  d88P Y88b. .d88P   ");
        System.out.println("   Y8888P    888    888   Y88888P     Y8888P      Y88888P \n ");

        System.out.println("888b     d888        d8888 888b    888 8888888        d8888  ");
        System.out.println("8888b   d8888       d88888 8888b   888   888         d88888  ");
        System.out.println("88888b.d88888      d88P888 88888b  888   888        d88P888  ");
        System.out.println("888Y88888P888     d88P 888 888Y88b 888   888       d88P 888  ");
        System.out.println("888 Y888P 888    d88P  888 888 Y88b888   888      d88P  888  ");
